...
export default function BreadCrumb(props) {
  return (
    <>
        <div className='breadCrumb bg-white shadow-sm flex items-center p-2.5  gap-x-1 md:gap-x-5 lg:gap-x-10 text-sm md:text-lg px-2 md:px-5 rounded-md md:rounded-xl'>
